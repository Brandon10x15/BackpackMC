...
- Interactions that cause duplication (double-click collect-to-cursor, right-click drag spread across the backpack GUI, etc.) are cancelled.
...
- Enable settings.updater.enabled and set check-url and download-url. Use /backpack update to check for updates.